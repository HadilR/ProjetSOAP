...
if __name__ == '__main__':
    ...
    solvabilite_server = make_server('127.0.0.1', 5001, solvabilite_wsgi_application)
    print("Service de solvabilite SOAP en cours d'exécution sur http://127.0.0.1:5001")
