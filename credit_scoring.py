...
if __name__ == '__main__':
    ...
    credit_scoring_server = make_server('127.0.0.1', 8005, credit_scoring_wsgi_application)
    print("Service de scoring de crédit en cours d'exécution sur http://127.0.0.1:8005")
