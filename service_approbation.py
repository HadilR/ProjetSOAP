...
if __name__ == '__main__':
    ...
    decision_approbation_server = make_server('127.0.0.1', 8003, decision_approbation_wsgi_application)
    print("Service de décision d'approbation SOAP en cours d'exécution sur http://127.0.0.1:8003")
