...
if __name__ == '__main__':
    ...
    evaluation_propriete_server = make_server('127.0.0.1', 5002, evaluation_propriete_wsgi_application)
    print("Service d'évaluation de propriété SOAP en cours d'exécution sur http://127.0.0.1:5002")
