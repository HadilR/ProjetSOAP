...
extraction_service_client = Client('http://localhost:5000/?wsdl')
...
credit_scoring_service_client = Client('http://localhost:5005/?wsdl')
...
solvabilite_service_client = Client('http://localhost:5001/?wsdl')
...
evaluation_propriete_service_client = Client('http://localhost:5002/?wsdl')
...
decision_approbation_service_client = Client('http://localhost:5003/?wsdl')
